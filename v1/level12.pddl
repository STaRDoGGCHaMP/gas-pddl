(define (problem level12)
  ...
  (:objects
    BlackSquare - square
    OrangeSquare - square
    l_0_7 l_1_7 l_2_7 l_3_7 l_4_7 l_5_7 l_6_7 l_7_7 - location
  ...
  (:init
    (at l_4_2 BlackSquare)
    (dir up BlackSquare)
    (at l_2_3 OrangeSquare)
    (dir right OrangeSquare)
    (at2 l_3_5 down)
    (at2 l_5_4 left)
    (noSquare l_0_7)  (noSquare l_1_7)  (noSquare l_2_7)  (noSquare l_3_7)  (noSquare l_4_7)  (noSquare l_5_7)  (noSquare l_6_7)  (noSquare l_7_7)
    (noSquare l_0_6)  (noSquare l_1_6)  (noSquare l_2_6)  (noSquare l_3_6)  (noSquare l_4_6)  (noSquare l_5_6)  (noSquare l_6_6)  (noSquare l_7_6)
    ...
    (noSquare l_0_3)  (noSquare l_1_3)                    (noSquare l_3_3)  (noSquare l_4_3)  (noSquare l_5_3)  (noSquare l_6_3)  (noSquare l_7_3)
    (noSquare l_0_2)  (noSquare l_1_2)  (noSquare l_2_2)  (noSquare l_3_2)                    (noSquare l_5_2)  (noSquare l_6_2)  (noSquare l_7_2)
    ...
    (adjacent l_0_7 l_1_7 right) (adjacent l_1_7 l_0_7 left) (adjacent l_1_7 l_2_7 right) (adjacent l_2_7 l_1_7 left) (adjacent l_2_7 l_3_7 right) (adjacent l_3_7 l_2_7 left) (adjacent l_3_7 l_4_7 right) (adjacent l_4_7 l_3_7 left) (adjacent l_4_7 l_5_7 right) (adjacent l_5_7 l_4_7 left) (adjacent l_5_7 l_6_7 right) (adjacent l_6_7 l_5_7 left) (adjacent l_6_7 l_7_7 right) (adjacent l_7_7 l_6_7 left)
    ...
    (adjacent l_0_6 l_0_7 up) (adjacent l_0_7 l_0_6 down) (adjacent l_1_6 l_1_7 up) (adjacent l_1_7 l_1_6 down) (adjacent l_2_6 l_2_7 up) (adjacent l_2_7 l_2_6 down) (adjacent l_3_6 l_3_7 up) (adjacent l_3_7 l_3_6 down) (adjacent l_4_6 l_4_7 up) (adjacent l_4_7 l_4_6 down) (adjacent l_5_6 l_5_7 up) (adjacent l_5_7 l_5_6 down) (adjacent l_6_6 l_6_7 up) (adjacent l_6_7 l_6_6 down) (adjacent l_7_6 l_7_7 up) (adjacent l_7_7 l_7_6 down))
  (:goal (and
	   (at l_3_4 BlackSquare)
