...
public class ProblemGenerator_v2 implements ProblemGenerator {

	@Override
	public void generate(GASLevel gaslevel) throws FileNotFoundException,
			UnsupportedEncodingException {
		// Identical to v1, with the exception that the noSquare predicate is
		// not used.

		// get the fields (less to write)
		...
		File dir = new File("../v2");
		dir.mkdir();

		// Create the target file
		PrintWriter writer = new PrintWriter(String.format("../v2/level%d.pddl", level), "UTF-8");
